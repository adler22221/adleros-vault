...
on it was seen that labour, too, has a dual character: in so far as it
finds its expression in value, it no longer possesses the same characteristics as when it is the creator of use-values. I was the first to
point out and examine critically this twofold nature of the labour
contained in commodities.12 As this point is crucial to an understanding of political economy, it requires further elucidation.
...
The coat is a use-value that satisfies a particular need.^[How should the fact that a thing can be used to satisfy various or even countless types of needs be accounted then? Is this a reflection of the Platonic 1-1 representative relationship of Ideas and Things?] A
specific kind of productive activity is required to bring it into
existence. This activity is determined by its aim, mode of operation, object, means and result. We use the abbreviated expression
'useful labour' for labour whose utility is represented by the use-value of its product, or by the fact that its product is a use-value.
...
of confronting each other as commodities.^[What does this mean?] Coats cannot be exchanged for coats, one use-value cannot be exchanged for another
of the same kind.

The totality of heterogeneous use-values or physical commodities reflects a totality of similarly heterogeneous forms of useful
labour, which differ in order, genus, species and variety: in short,
a social [[division of labour]].^[Is this another case of 1-1 representation? And how is the fact that some use-value doesn't entail labor accounted?] This [[division of labour]] is a necessary
...
primitive Indian community, although the products do not thereby become commodities. Or, to take an example nearer home,
...
commodities.^[I feel that there should be counter examples to this.]

To sum up, then: the use-value of every commodity contains
useful labour, i.e. productive activity of a definite kind, carried on
