...
The commodity is, first of all, an external object^[Should commodity still be conceived as an external object in a service, information-economy?], a thing which
...
stomach, or the imagination, makes no difference. 2 Nor does it
matter here how the thing satisfies man's need, whether directly as
a means of subsistence, i.e. an object of consumption, or indirectly as a means of production.
...
supplying the wants of the mind' ^[However, Buddha also considers the wants of the mind the main source of sufferings.] (Nicholas Barbon, A Discourse on Coining
...
and hence of the manifold uses of things is the work of history. 3
So also is the invention of socially recognized standards of measurement for the quantities of these useful objects. The *diversity* of the measures for commodities arises in part from the *diverse nature* ^[Yet the measurement has been standardized? So as the measurement of persons?]
of the objects to be measured, and in part from convention.

> 3. 'Things have an intrinsick vertue' (this is Barbon's special term for usevalue) 'which in all places have the same vertue; as the loadstone to attract
...
The usefulness of a thing makes it a use-value.4 But this usefulness does not dangle in mid-air. It is conditioned by the physical
...
for instance iron, com, a diamond, which is the use-value or
useful thing.^[Still this question: How is non-physical services accounted in this definition?] This property of a commodity is independent of the
...
material for a special branch of knowledge, namely the commercial knowledge of commodities.5 ==Use-values are only realized
...
[Triiger] of ... exchange-value.

> 4. 'The natural worth of anything consists in its fitness to supply the necessities, or serve the conveniences of human life' (John Locke, 'Some Considerations on the Consequences of the Lowering of Interest' (1691), in Works,
London, 1777, Vol. 2, p. 28). In English writers of the seventeenth century we
still often find the word 'worth' used for use-value and 'value' for exchangevalue. This is quite in accordance with the spirit of a language that likes to use
...
the proportion, in which ==use-values of one kind exchange for use values of another kind. 6== This relation changes constantly with
...
the commodity, inherent in it, seems a contradiction in terms. 7 Let
...
Trosne, De l'intiret social, in Physiocrates, ed. Daire, Paris, 1846, p. 889).
