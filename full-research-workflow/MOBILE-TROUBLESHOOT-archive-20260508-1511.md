...
Archived: 2026-05-08 15:12 (response written to MOBILE-TROUBLESHOOT-RESPONSE.md the same minute).

---

# MOBILE-TROUBLESHOOT â€” out-of-band diagnostic channel
...
> **Response time:** typically 60â€“120 seconds after you save.
...
```
## YYYY-MM-DD HH:MM
**What happened:** [what you observed â€” e.g., "tapped session in Code tab, got 'session offline' badge, waited 5 min, no green dot"]
**What I want:** [diagnose / restart / advise / something else]
```

---

## (your entry goes below â€” replace this line and everything below it)

## 2026-05-08 HH: MM
**What happened:** second smoke test
**What I want:** confirm full loop works after watcher refactor
