...
value character emerges here through its own relation to the
second commodity.
...
the two kinds of labour, to the characteristic they have in common of being human labour. This is a roundabout way of saying
that weaving too, in so far as it weaves value, has nothing to distinguish it from tailoring, and, consequently, is abstract human
...
by Marx as the founder ofmodem political economy (see below, p. 174, n. 34).
...
but is not itself value.== ^[Can be related to the distinction between "activities" v.s. "value propositions" in Business Model Generation, or the distinction between learning by doing v.s. [[德中學 Learning by Caring]]] It becomes value in its coagulated state, in
objective form. The value of the linen as a congealed mass of
human labour can be expressed only as an 'objectivity' [Gegenstiindlichkeit], a thing which is materially different from the linen
