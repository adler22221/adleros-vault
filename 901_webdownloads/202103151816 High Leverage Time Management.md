...
Author: 
Source: 
https://www.nfx.com/post/time-management-for-founders/
Retrieved {March 15, 2021}

> The Founders of Trulia, Cloudflare, Eventbrite, Product Hunt, Udemy, Virta & Getaround share their highest leverage time management techniques.

# High Leverage Time Management
## High Leverage Time Management

_by Pete Flint ([@PeteFlint](https://twitter.com/peteflint)). Pete is a General Partner at NFX, a seed-stage venture firm based in San Francisco._

![Visuals for High Leverage Time Management](https://www.nfx.com/wp-content/uploads/2020/09/Final-OG.jpg)

For Founders, time is always in short supply. Being deliberate about how you spend it is an enduring, daily challenge.

In the early stages of your company, before you’ve achieved [product-market fit](https://www.nfx.com/post/10-places-to-find-product-market-fit/), time management is easier because there’s only one thing that really matters: getting early users to love your product. This gives you a simple way to prioritize your calendar.

But as you go from [running a product to becoming a CEO](https://www.nfx.com/post/how-ceos-think-mental-models-shift-founder-to-ceo/), it’s no longer as simple. Effective time management is about prioritizing and focus. But what you should focus on changes dramatically as you scale your company.

As a result, you have to develop a more robust set of time management tools and techniques. Today I want to share some of the techniques and mindset that I used as Founder and CEO of [Trulia](https://www.nfx.com/post/the-nfx-of-trulia-building-a-3-5-billion-marketplace/) that gave me speed, focus, and effectiveness — resulting in the highest return on my time.

Also, because there are many equally effective approaches you can take and there is truly no one-size-fits-all solution, I invited a few breakthrough Founders to share their best time management advice, which you’ll find included below. **(Thank you [Michelle Zatlyn](https://twitter.com/zatlyn),  [Ryan Hoover](https://twitter.com/rrhoover), [Gagan Biyani](https://twitter.com/gaganbiyani), [Sami Inkinen](https://twitter.com/samiinkinen), [Julia Hartz](https://twitter.com/juliahartz), and [Jessica Scorpio](https://twitter.com/jessicascorpio).)**

## Use routines (and speed) to reduce cognitive load

-   **Running a tight schedule.** For example, my day is scheduled ahead of time in 15-minute increments. US President Bush used to [schedule his workday](https://www.axios.com/donald-trump-schedule-obama-bush-clinton-513c73ff-4d15-4e7a-9676-334557a894ee.html) in 10-minute increments, and likewise, President Obama’s workday included very little unscheduled time.
-   **Creating a routine** to reduce unnecessary cognitive load and complexity in life. Mark Zuckerberg famously [wears the same shirt every day](https://careers.workopolis.com/advice/the-reason-mark-zuckerberg-wears-the-same-shirt-every-day/) “to make as few decisions as possible about anything else” except how to run his company. You don’t have to take it to that extreme, however — personally I think you need to have some flexibility, and allow for the kind of serendipity in your day that spurs creativity by changing things up on occasion.
-   **If it can be done quickly, do it _now._** Get in the mindset that if something can be done quickly, do it now, in keeping with David Allen’s famous concept from Getting Things Done that you should never put off something that takes two minutes or less, like sending a quick email reply. When you get something done quickly, it reduces your mental load and also establishes a habit of speed for the rest of your organization.
...
![](https://www.nfx.com/wp-content/uploads/2020/09/CU-1-1-scaled.jpg)
...
-   **Learn from others.** As I wrote in [How CEOs Think](https://www.nfx.com/post/how-ceos-think-mental-models-shift-founder-to-ceo/), seeking out advice and feedback is key. The more advice you can get on your time management, the better. Get regular feedback from a coach, mentor, or peer set so you can learn how to improve your time management skills so that your organization can thrive as well.
...
![](https://www.nfx.com/wp-content/uploads/2020/09/CU-2-1.jpg)

[![Connect with Pete Flint](https://www.nfx.com/wp-content/uploads/2019/11/Partner-Card-Pete-Flint.jpg)](https://thecompanybrief.com/investors/nfx?e=pf-essay&utm_source=nfxessays&utm_content=time-management-for-founders)
