...
> Twelve business models for authors based around publishing books and related products and services. Which one is right for you?

# Business Models for Authors: from the Alliance of Independent Authors
![Orna Ross What is an authorpreneur](https://selfpublishingadvice.org/wp-content/uploads/2020/01/Orna-Head-Shoulders-Color-200x300.jpg)

_Orna Ross, Director of ALLi_

_This post outlines twelve business models for indie authors that are working right now, those most widely used by members of the [Alliance of Independent Authors](https://allianceindependentauthors.org/?affid=100)._ 
...
There’s a popular Facebook group for author publishing ebooks wide called [Wide for the Win](https://www.facebook.com/groups/wideforthewin/announcements) run by three authors using this model, Erin Wright, Suzie O’Connell and Skye MacKinnon. A  and
...
Novelists and poets podcasters and YouTubers give paid online performances, sometimes called laptop concerts or web revues or internet events, where they air their work for a fee as audio or video content. These events can be **reader-directed**, making the show available online for a small fee or suggested ticket price or donation, and reaching audiences who can’t physically attend a performance. They are hosted on platforms such as [Stageit](https://www.stageit.com/site/landing), or more informally using social media tools like [Facebook or Instagram Live](https://live.fb.com/).
...
An example is Dan Blank. For more than a decade, Dan has worked full-time with thousands of writers and creators to develop a human-centered approach to marketing and reaching readers through his company [We Grow Media](https://wegrowmedia.com/). “Human-centered marketing is what I am here to help students to accomplish–so yes, they get direct one-on-one feedback and assistance from me. I answer questions directly, I brainstorm ideas, and I ensure they have a clear strategy to reach your goals.”
...
Some authors have a following that is attractive to brands. They might sponsor an aspect of an author’s work in return for exposure to the author’s followers and fans. Individual books can also be sponsored or carry advertising. **_The Bulgari Connection_** by [Fay Weldon](https://en.wikipedia.org/wiki/Fay_Weldon) (2000), for example, was sponsored by the eponymous Italian jewellery company. Under the deal, Weldon was required to mention Bulgari at least 12 times but was happy to mention them 34 times. Sponsorship and advertising in books is controversial, and can raise ethical questions.
...
These ten business models for indie authors represent what’s working now, but with our changeable industry the future might hold ten more possibilities. (See ALLi’s [**Self-Publishing 3.0 Campaign**](https://www.allianceindependentauthors.org/self-publishing-3-0/) for more on this.
