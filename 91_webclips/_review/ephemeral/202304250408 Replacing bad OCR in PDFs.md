...
Source: 
https://jmuccigr.github.io/blog/2020/09/15/replacing-bad-ocr-in-pdfs/
Retrieved 
...
# Replacing bad OCR in PDFs
## _[de vita sua](https://jmuccigr.github.io/blog/)_

a blog

Page last modified: 27 3月 2022

[View My GitHub Profile](https://github.com/Jmuccigr)
...
![JSTOR scan showing two typical OCR problems](https://jmuccigr.github.io/images/jstor_ocr.jpg)

JSTOR scan showing two typical OCR problems
...
2.  [ghostscript](https://www.ghostscript.com/): an interpreter for PDF (and for the PostScript language), which I use to remove the text and images from the PDF.
3.  [ocrmypdf](https://github.com/jbarlow83/OCRmyPDF): this is a pretty nice bit of software by someone who knows a lot more about PDFs than I do. It adds OCR to your PDF, as the name suggests, but often also modifies the underlying images, so I use it to create the OCR, but then get rid of the non-OCR portions.
4.  [PyPDF2](https://pypi.org/project/PyPDF2/): a python library to manipulate PDFs, which I use to remove the text from the PDF.
...
PS I’ve talked about some of my approaches to the other type of problem where the underlying images are inadequate in [a few other posts](https://jmuccigr.github.io/blog/tags/#scanning).

  
Tags - [qpdf](https://jmuccigr.github.io/blog/tags/#qpdf) - [ghostscript](https://jmuccigr.github.io/blog/tags/#ghostscript) - [cli](https://jmuccigr.github.io/blog/tags/#cli) - [technology](https://jmuccigr.github.io/blog/tags/#technology) - [pdf](https://jmuccigr.github.io/blog/tags/#pdf)
