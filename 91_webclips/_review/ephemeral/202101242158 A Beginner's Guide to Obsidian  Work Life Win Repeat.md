...
Source: 
https://www.worklifewinrepeat.com/beginners-guide-obsidian/
...
In previous articles I had spoke about how the best way to have ideas was to [write everything down and network your notes](https://www.worklifewinrepeat.com/practical-guide-ideas/#obsdideas). Writing down your early hunches or half formed thoughts needs no more than a notepad and the right routine. But networking those thoughts to form a coherent and original idea needs a system to be stacked on top of that layer.

Fortunately, we live in an age where if you stumble upon a concept, options are not far behind. In this article I will take you through a system that I have put my faith and thoughts into. It is an essential part of the [Creation Hub](https://www.worklifewinrepeat.com/practical-life-os-clickup/#obsdcreation) of my Life OS system. The last few articles I've posted on this blog, including this one, emerged from the [connections discovered](https://www.worklifewinrepeat.com/intro-networked-note-taking/#obsdbilinks) by using this application. I'm talking about Obsidian.
...
Obsidian is the brainchild of Shida Li and Erica Xu who have worked together on [Dynalist](https://dynalist.io/). The design and layout seems to have some influence from their previous experience
...
If you would like to get deep into the mindset of networked note-taking before you start practicing it, head over [here](https://www.worklifewinrepeat.com/intro-networked-note-taking/) first. I'll wait. But if you are already a believer and would like to jump on board, here's what you need to remember.
...
Are you ready? Good. Then head over [here](https://obsidian.md/), choose the appropriate version for your OS (Windows/Mac/Linux) and download. Avoid looking at the screenshot on that page if you fear being overwhelmed. We'll get there, step-by-step.
...
![Obsidian Vault screenshot](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsidian-Create-your-vault.png)
...
![Obsidian Interface Labeled](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsidian-Interface-1024x543.png)

1.  **Toolbar:** At the extreme left are the basic tools that you can hover over to understand their function. Note the button to “open graph view”, this will grow more useful as you grow your personal notes library and so, will be discussed later
2.  **Files and Folders:** This is where you can view the notes you record and the folders we spoke about earlier. You also have access to buttons that will help you create new files/folders. Files can be dragged and dropped into any folder and folders can be collapsed using the toggle button
3.  **Active document:** This empty expanse is where you will start to build your first note (and then some)
4.  **Links directory:** At the right is where all the connections you made for the current document can be viewed. This is also where Obsidian can suggest un-linked mentions to this document that you may want to investigate.
...
![File Settings](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsidian-File-Settings-1024x479.png)

File Settings

![Appearance Settings](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsidian-Appearance-Settings-1024x478.png)
...
![Obsidian Edit vs View Mode](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsd-Edit-Mode-vs-View-Mode-1024x545.png)

The notes appear by default in “Edit Mode”, which exposes some of the raw notations that disappear if you choose “View Mode”.

“View mode” is where data can be presented to an external viewer. “View Mode” is not visible by default, hold down Ctrl/Cmd and Click on the note icon at the top right corner of the note window to open “View Mode” side-by-side as I've shown in the screenshot above. _Note that you cannot change content on the “View Mode” pane._
...
![Obsidian Headings](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsd-Headings.png)
...
![Block example in Obsidian](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/InkedObsidian-Block_LI.jpg)
...
Not so similar to MS Word: “_quotation marks”_ and (_brackets)_ auto-close. Keep that in mind and it'll speed up your typing process. Go ahead, try it out.
...
![Obsidian Link to Note](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsd-Basic-Linking-and-Embedding.gif)

#### Level 2: Link or Embed a Heading within the Note- \[\[The name of the note#Heading\]\]

![Obsidian Link to Heading](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsd-Link-to-Heading.gif)

#### Level 3: Link or Embed a Block within a Note- \[\[The name of the note^blockname\]\]

![Obsidian Link to Block](https://www.worklifewinrepeat.com/wp-content/uploads/2020/11/Obsd-Link-to-Block.gif)
...
At this stage, Obsidian is no longer a black box to you. You are equipped with the “80/20” resources needed to operate Obsidian. What you need now is the experience of using them. That's a function of the routines you've set and where Obsidian features within them.
...
Check back in soon or sign in to my newsletter to be notified of the upcoming second part of this articles and much more. You can also choose to connect with me on [Twitter](https://twitter.com/worklifewinrep) to stay updated.

**Update:** You can further your knowledge of Obsidian in my second part of this article. Head over to: [Obsidian: A Taste of Superpowers](https://www.worklifewinrepeat.com/obsidian-superpowers/)
