...
#excerpts
Author: Arunkumar Rajasekaran
Source: 
https://www.worklifewinrepeat.com/intro-networked-note-taking/
Retrieved {January 24, 2021}

> Demystify the world of digital note-taking systems and where they're headed. Step into Networked Note-taking and ignite your idea engine.

# Introduction to Networked Note-taking | Work Life Win Repeat
A[blogger](https://www.brainpickings.org/about/) born in Bulgaria finds a permanent spot in the US Library of Congress for her pursuit of the power of reading. A [German sociologist](https://medium.com/emvi/luhmanns-zettelkasten-a-productivity-tool-that-works-like-your-brain-abe2d53a2948) uses his notes to produce more than 70 books and nearly 400 scholarly articles ranging from _law_ to _love_. Stars on the epaulette of the written word. Their incredible body of work would not be possible without a systematic process of recording, sorting and applying their thoughts.
...
In this article I would like to demystify the world of digital note taking systems and where they're headed. We have briefly spoken about it [here](https://www.worklifewinrepeat.com/effective-learning/#networkednotes).
...
In order to understand Networked Note-taking, you must retrace the steps of note-taking itself. Going as far back as the [1500s in Europe](https://dash.harvard.edu/bitstream/handle/1/4774908/blair_notetaking.pdf?sequence=1), note taking has aided scholars, travelers and scientists to compile their ideas into coherent narratives or treatises. Early consumers of these content maintained notes in the margins of those books, sometimes transferring them to their notebooks to create derivative content.
...
Universities even taught the students many of the popular ones, ensuring that the system carried on in work spheres for many of them. The [Cornell Method](https://www.umfk.edu/student-success/academic-support/notes/), mind maps and [ishikawa diagrams](https://asq.org/quality-resources/fishbone) became popular for their emphasis on approaching a subject through summarization and visualization. This had some positive impact in improving [Learning for Inference.](https://www.worklifewinrepeat.com/effective-learning/#inference)
...
Let's revisit the German sociologist we spoke about at the beginning of this article. [Niklas Luhmann](https://en.wikipedia.org/wiki/Niklas_Luhmann)‘s use of a mid 1500s research technique is now at the heart of a revolution in thinking and creating in the age of digital tectonic shifts. It is a note management system called [Zettelkasten](https://zettelkasten.de/) (German for “slip box”)

Unlike methods that preceded it, which focused on making you understand the concept you were trying to record, Zettelkasten was designed to create a democratic environment for notes to co-exist and link where they may. It promoted new connections between concepts. Niklas [[Luhmann, Niklas|Luhmann]] credited his prolific output to this technique.

The methodology is absorbed an interpreted in Sönke Ahrens' well received book “[How to Take Smart Notes](https://amzn.to/3cEosSF)“. What happened once this system gained popularity amongst software developers is the subject of the rest of this article and will become an ongoing topic for us to explore.
...
It began as a from the notes I'd taken for one of my previous [articles](https://www.worklifewinrepeat.com/effective-learning/). While putting together the research on Learning techniques I had amassed stray notes on the subject of distributed intelligence, zettelkasten and in the same breath, networked notetaking. Having all these notes in Obsidian, and linked through a breadcrumb trail of backlinks helped create the skeleton for this article. Combine that with my ongoing research on Roam and Obsidian, this article just came together by itself.

If you want to know more about using Obsidian, I have a [beginner's guide right here](https://www.worklifewinrepeat.com/beginners-guide-obsidian/).

![Obsidian linked notes](https://www.worklifewinrepeat.com/wp-content/uploads/2020/09/GIF-Obsidian-linked-notes.gif)
...
But in either case this is a rewarding experience and it encourages you to revisit your old notes often to see if Roam has discovered any new connections that has escaped your observation. This is serendipitous discovery: _The “Aha!” moment when you realize that your notes on thermal responsiveness across the color spectrum explains why your bread recipe needs you to put foil on the loaf in the last 15 minutes of its cooking._
...
Networked Note-taking makes Personal Medical Records| more awesome!
...
Here we lean on the remarkable example of Dr [[Luhmann, Niklas|Luhmann]] himself. Using a networked note-taking platform as the primary home of your thinking leads to an interlinked repository of ideas that can be interpreted in multiple ways depending on which thread you choose to follow.
...
Platforms like Roam research also enable integrating a [spaced repetition](https://www.worklifewinrepeat.com/effective-learning/#spacedrep) framework within it. This makes the platform the perfect solution for assessing your recollection and preparing for tests.

Part of creating a Life OS is to incorporate an active knowledge management engine that would provide the inputs for research and creative output in our personal field. This becomes part of your [Creation Hub](https://www.worklifewinrepeat.com/life-os-elements/#creationhub).
...
Unfortunately, this is my favorite starting point of ideas as I have explained [earlier](https://www.worklifewinrepeat.com/life-os-elements/#creationhub) with reference to [Notability](https://www.gingerlabs.com/).
...
[![Obsidian Logo](https://www.worklifewinrepeat.com/wp-content/uploads/2020/09/Obsidian-Logo.png)](https://obsidian.md/)
...
**Learning resource: [A Beginner's Guide to Obsidian](https://www.worklifewinrepeat.com/beginners-guide-obsidian/)**

[![Roam Research](https://www.worklifewinrepeat.com/wp-content/uploads/2020/07/Roam-Research-300x300.png)](https://roamresearch.com/)

The current darling at the forefront of networked thought. I have mentioned it in earlier articles [here](https://www.worklifewinrepeat.com/intro-to-life-os/#roam). People have gone as far trying to craft an entire Life OS system on the basis of this platform. While starting up on it is simple, unlocking its power involves passing through a learning curve and adopting a freeform mindset for your notes.

**Learning resource:** [Anonym.s Course](https://youtu.be/cHzuPptZRe4)

[![Notion](https://www.worklifewinrepeat.com/wp-content/uploads/2020/07/Notion_app_logo-300x300.png)](https://www.notion.so/)
...
**Learning resource:** [Bi-directional Linking in Notion](https://youtu.be/JXZHxO3p-iI)

[![RemNote Logo](https://www.worklifewinrepeat.com/wp-content/uploads/2020/09/RemNoteLogo.png)](https://www.remnote.io/homepage)
...
**Learning resource:** [RemNote overview and course](https://www.youtube.com/channel/UCgETcD9IVBbTIL9OjCoaloA)

[![LiquidText Logo](https://www.worklifewinrepeat.com/wp-content/uploads/2020/09/ltlogo-300x68.png)](https://www.liquidtext.net/)
...
**Learning resource:** [Recent review by Paperless X](https://youtu.be/Dp_ErMnQTd8)
...
I intend to continue writing about this topic, as it is an essential component of my [Life OS](https://www.worklifewinrepeat.com/practical-life-os-clickup/). Let me know if you want me to specifically address any use case or feature. You can reach out to me on [mail](https://www.worklifewinrepeat.com/contact/) or [twitter](https://twitter.com/worklifewinrep).
